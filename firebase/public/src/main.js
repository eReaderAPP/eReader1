...
import {Result, Layout, Menu, Icon, Button, Spin, Card, Avatar, Row, Col, Upload, Progress, Drawer, Tooltip, Switch, List, Slider, Input, InputNumber, Radio} from 'ant-design-vue'
...
Vue.use(Input).use(InputNumber).use(Radio).use(Result)
