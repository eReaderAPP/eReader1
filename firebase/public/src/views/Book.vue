<template>
  <div class="entry">
    ...
    >
      ...
      <div class="controller-area">
        <a-row type="flex" justify="start">
          ...
          <a-col :span="10">
            <a-slider v-model="settingOption.fontSize" :min="15" :max="40" />
          </a-col>
          <a-col style="margin-left: auto;">
            <a-input-number v-model="settingOption.fontSize" :min="15" :max="40" style="marginLeft: 16px" />
          </a-col>
        </a-row>
        <a-row type="flex" justify="start">
    ...
    >
      <div slot="title">
        <a-icon type="database" style="font-size: 14px;"/><span class="setting-title">Chapter display</span>
      </div>
